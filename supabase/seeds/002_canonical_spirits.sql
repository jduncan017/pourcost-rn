...
--
-- Taxonomy locked per docs/database_decisions.md (47 Spirit subs).
--
...
VALUES
  ('Vodka', NULL, 'Spirit', 'Plain', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 40, NULL,
   'Generic vodka reference. Use when recipe works with any neutral spirit.',
   '["neutral","clean"]'::jsonb, 'pending'),
  ('Gin', NULL, 'Spirit', 'Gin: London Dry', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 40, NULL,
  ...
  ('Bourbon', NULL, 'Spirit', 'Bourbon', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 45, 'Kentucky, USA',
...
INSERT INTO canonical_products (name, brand, category, subcategory, default_sizes, abv, origin, description, flavor_notes, enrichment_status)
VALUES
  ('Tito''s Handmade Vodka', 'Tito''s', 'Spirit', 'Plain', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 40, 'Austin, TX, USA',
   'Corn-based American vodka. The top-selling spirit in the US.',
   '["clean","slightly sweet","smooth"]'::jsonb, 'pending'),
  ('Grey Goose', 'Grey Goose', 'Spirit', 'Plain', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 40, 'France',
   'French wheat-based vodka. Premium positioning; used in upscale bar programs.',
   '["soft","mineral","smooth"]'::jsonb, 'pending'),
  ('Ketel One', 'Ketel One', 'Spirit', 'Plain', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 40, 'Netherlands',
   'Dutch wheat-based vodka. Crisp, slightly peppery character.',
   '["crisp","peppery","clean"]'::jsonb, 'pending'),
  ('Absolut', 'Absolut', 'Spirit', 'Plain', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 40, 'Sweden',
   'Swedish wheat-based vodka. Widely available; standard well vodka in many bars.',
   '["clean","grain","mild"]'::jsonb, 'pending'),
  ('Smirnoff', 'Smirnoff', 'Spirit', 'Plain', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 40, 'Various',
   'Mass-market vodka. Common well spirit.',
   '["neutral","clean"]'::jsonb, 'pending'),
  ('Belvedere', 'Belvedere', 'Spirit', 'Plain', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 40, 'Poland',
   'Polish rye-based vodka. Premium grain character.',
   '["rye","creamy","slightly sweet"]'::jsonb, 'pending'),
  ('Stolichnaya', 'Stolichnaya', 'Spirit', 'Plain', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 40, 'Latvia',
   'Wheat and rye blend vodka. Often called Stoli; classic Bloody Mary base.',
   '["grain","mild","clean"]'::jsonb, 'pending'),
  ('Chopin', 'Chopin', 'Spirit', 'Plain', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Poland',
   'Polish potato vodka. Creamy and full-bodied compared to grain vodkas.',
   '["creamy","earthy","full-bodied"]'::jsonb, 'pending'),
  ('Hangar 1', 'Hangar 1', 'Spirit', 'Plain', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Alameda, CA, USA',
   'California craft vodka. Wheat and grape blend.',
   '["clean","subtle fruit"]'::jsonb, 'pending'),
  ('Deep Eddy', 'Deep Eddy', 'Spirit', 'Plain', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 40, 'Austin, TX, USA',
   'Texas-made corn-based vodka. Known for flavored expressions.',
   '["clean","slightly sweet"]'::jsonb, 'pending'),
  ('Reyka', 'Reyka', 'Spirit', 'Plain', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Iceland',
   'Icelandic vodka filtered through volcanic rock. Wheat and barley blend.',
   '["clean","mineral","crisp"]'::jsonb, 'pending'),
  ('Hangar One', 'Hangar 1', 'Spirit', 'Plain', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Alameda, CA, USA',
...
-- ============================================================
-- GIN (specific brands)
-- Locked subs: Gin: London Dry / Plymouth / Old Tom / Genever /
--              Navy Strength / Modern
-- ============================================================

INSERT INTO canonical_products (name, brand, category, subcategory, default_sizes, abv, origin, description, flavor_notes, enrichment_status)
VALUES
  ('Tanqueray London Dry', 'Tanqueray', 'Spirit', 'Gin: London Dry', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 47.3, 'England',
   'Classic London Dry gin. Juniper-forward with coriander and angelica. The default cocktail gin for many bartenders.',
   '["juniper","crisp","citrus"]'::jsonb, 'pending'),
  ('Tanqueray No. Ten', 'Tanqueray', 'Spirit', 'Gin: London Dry', '[{"kind":"milliliters","ml":750}]'::jsonb, 47.3, 'England',
   'Tanqueray''s premium expression. Fresh citrus and chamomile from a small still ("Tiny Ten").',
   '["citrus","floral","crisp"]'::jsonb, 'pending'),
  ('Bombay Sapphire', 'Bombay', 'Spirit', 'Gin: London Dry', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 47, 'England',
  ...
  ('Hendrick''s', 'Hendrick''s', 'Spirit', 'Gin: Modern', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 44, 'Scotland',
  ...
  ('Beefeater', 'Beefeater', 'Spirit', 'Gin: London Dry', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 47, 'England',
   'Traditional London Dry, distilled in central London. Strong juniper and citrus.',
   '["juniper","citrus","classic"]'::jsonb, 'pending'),
  ('Plymouth', 'Plymouth', 'Spirit', 'Gin: Plymouth', '[{"kind":"milliliters","ml":750}]'::jsonb, 41.2, 'Plymouth, England',
  ...
  ('The Botanist', 'The Botanist', 'Spirit', 'Gin: Modern', '[{"kind":"milliliters","ml":750}]'::jsonb, 46, 'Islay, Scotland',
   'Made by Bruichladdich on Islay. 22 hand-foraged Islay botanicals.',
   '["botanical","floral","herbal"]'::jsonb, 'pending'),
  ('Aviation', 'Aviation', 'Spirit', 'Gin: Modern', '[{"kind":"milliliters","ml":750}]'::jsonb, 42, 'Portland, OR, USA',
   'New American gin style. Less juniper-heavy, with lavender and cardamom.',
   '["floral","lavender","mild juniper"]'::jsonb, 'pending'),
  ('Sipsmith London Dry', 'Sipsmith', 'Spirit', 'Gin: London Dry', '[{"kind":"milliliters","ml":750}]'::jsonb, 41.6, 'London, England',
   'Modern small-batch London Dry. Founded 2009; helped revive London distilling.',
   '["juniper","citrus","classic"]'::jsonb, 'pending'),
  ('Monkey 47', 'Monkey 47', 'Spirit', 'Gin: Modern', '[{"kind":"milliliters","ml":500}]'::jsonb, 47, 'Black Forest, Germany',
   'Black Forest gin made with 47 botanicals. Complex and pricey.',
   '["botanical","peppery","forest"]'::jsonb, 'pending'),
  ('Empress 1908', 'Empress', 'Spirit', 'Gin: Modern', '[{"kind":"milliliters","ml":750}]'::jsonb, 42.5, 'Victoria, BC, Canada',
   'Indigo color from butterfly pea flower; turns pink with citrus. Visual impact gin.',
   '["floral","grapefruit","tea"]'::jsonb, 'pending'),
  ('Bombay Original', 'Bombay', 'Spirit', 'Gin: London Dry', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 43, 'England',
...
-- ============================================================
-- RUM (specific brands)
-- Locked subs: White / Gold / Aged / Dark / Spiced / Overproof /
--              Rhum Agricole / Cachaça / Other Rum
-- ============================================================

INSERT INTO canonical_products (name, brand, category, subcategory, default_sizes, abv, origin, description, flavor_notes, enrichment_status)
VALUES
  ('Bacardi Superior', 'Bacardi', 'Spirit', 'White Rum', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 40, 'Puerto Rico',
  ...
  ('Bacardi 8', 'Bacardi', 'Spirit', 'Aged Rum', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Puerto Rico',
   'Aged 8 years. Used as a sipping rum and in stirred rum cocktails.',
   '["caramel","oak","vanilla"]'::jsonb, 'pending'),
  ('Don Q Cristal', 'Don Q', 'Spirit', 'White Rum', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 40, 'Puerto Rico',
  ...
  ('Plantation 3 Stars', 'Plantation', 'Spirit', 'White Rum', '[{"kind":"milliliters","ml":750}]'::jsonb, 41.2, 'Caribbean',
   'Blend of Trinidad, Barbados, and Jamaica rums. Modern bar workhorse white rum.',
   '["funky","tropical","light"]'::jsonb, 'pending'),
  ('Mount Gay Eclipse', 'Mount Gay', 'Spirit', 'Gold Rum', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 40, 'Barbados',
   'Bajan blended rum. Classic for rum punches and Hurricanes.',
   '["caramel","oak","banana"]'::jsonb, 'pending'),
  ('Mount Gay Black Barrel', 'Mount Gay', 'Spirit', 'Aged Rum', '[{"kind":"milliliters","ml":750}]'::jsonb, 43, 'Barbados',
   'Mount Gay finished in heavily charred bourbon barrels.',
   '["smoke","oak","spice"]'::jsonb, 'pending'),
  ('Appleton Estate Reserve Blend', 'Appleton Estate', 'Spirit', 'Aged Rum', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Jamaica',
   'Jamaican blended rum with funky pot still character. Used in Mai Tais and tiki drinks.',
   '["funky","banana","tropical"]'::jsonb, 'pending'),
  ('Diplomatico Reserva Exclusiva', 'Diplomatico', 'Spirit', 'Aged Rum', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Venezuela',
   'Sweet, dessert-style aged rum. Popular for sipping and rum Old Fashioneds.',
   '["sweet","caramel","dried fruit"]'::jsonb, 'pending'),
  ('Plantation Xaymaca', 'Plantation', 'Spirit', 'Aged Rum', '[{"kind":"milliliters","ml":750}]'::jsonb, 43, 'Jamaica',
   'High-ester Jamaican rum. Funky pot still character; tiki favorite.',
   '["funky","tropical","banana"]'::jsonb, 'pending'),
  ('Smith and Cross', 'Smith and Cross', 'Spirit', 'Overproof Rum', '[{"kind":"milliliters","ml":750}]'::jsonb, 57, 'Jamaica',
  ...
  ('Wray and Nephew White Overproof', 'Wray and Nephew', 'Spirit', 'Overproof Rum', '[{"kind":"milliliters","ml":750}]'::jsonb, 63, 'Jamaica',
   'White overproof Jamaican rum. Classic Tiki and Caribbean cocktail booster.',
   '["funky","intense","overproof"]'::jsonb, 'pending'),
  ('Captain Morgan Original Spiced', 'Captain Morgan', 'Spirit', 'Spiced Rum', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 35, 'Various',
   'Best-selling spiced rum in the US. Vanilla-forward; mass market.',
   '["vanilla","spiced","sweet"]'::jsonb, 'pending'),
  ('Sailor Jerry Spiced', 'Sailor Jerry', 'Spirit', 'Spiced Rum', '[{"kind":"milliliters","ml":750}]'::jsonb, 46, 'Caribbean',
   'Higher-proof spiced rum than Captain Morgan. Vanilla and cinnamon dominant.',
   '["vanilla","cinnamon","spiced"]'::jsonb, 'pending'),
  ('Goslings Black Seal', 'Goslings', 'Spirit', 'Dark Rum', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 40, 'Bermuda',
   'Bermudian dark rum. Required for an authentic Dark and Stormy.',
   '["molasses","dark","caramel"]'::jsonb, 'pending'),
  ('Rhum Clement VSOP', 'Clement', 'Spirit', 'Rhum Agricole', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Martinique',
...
-- Tequila locked subs: Blanco / Reposado / Anejo / Extra Anejo / Cristalino
-- Mezcal locked subs: Joven / Reposado / Anejo
-- ============================================================

INSERT INTO canonical_products (name, brand, category, subcategory, default_sizes, abv, origin, description, flavor_notes, enrichment_status)
VALUES
  ('Patron Silver', 'Patron', 'Spirit', 'Tequila Blanco', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 40, 'Jalisco, Mexico',
   'Premium blanco tequila. Smooth, slightly sweet; mass-market premium.',
   '["agave","peppery","smooth"]'::jsonb, 'pending'),
  ('Don Julio Blanco', 'Don Julio', 'Spirit', 'Tequila Blanco', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 40, 'Jalisco, Mexico',
   'Premium blanco. Bright agave with white pepper finish.',
   '["agave","pepper","bright"]'::jsonb, 'pending'),
  ('Don Julio 1942', 'Don Julio', 'Spirit', 'Tequila Anejo', '[{"kind":"milliliters","ml":750}]'::jsonb, 38, 'Jalisco, Mexico',
   'Don Julio''s premium anejo. Distinctive bottle; popular for sipping.',
   '["caramel","oak","vanilla"]'::jsonb, 'pending'),
  ('Casamigos Blanco', 'Casamigos', 'Spirit', 'Tequila Blanco', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 40, 'Jalisco, Mexico',
   'Celebrity-founded blanco. Smooth and sweet; popular at upscale cocktail bars.',
   '["sweet","mild agave","smooth"]'::jsonb, 'pending'),
  ('Casamigos Reposado', 'Casamigos', 'Spirit', 'Tequila Reposado', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Jalisco, Mexico',
   'Reposado from Casamigos. Caramel and oak with the softness Casamigos is known for.',
   '["caramel","oak","mellow"]'::jsonb, 'pending'),
  ('Herradura Silver', 'Herradura', 'Spirit', 'Tequila Blanco', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Jalisco, Mexico',
   'Silver tequila aged 45 days (legally still blanco). Earthier than most blancos.',
   '["earthy","agave","roasted"]'::jsonb, 'pending'),
  ('Herradura Reposado', 'Herradura', 'Spirit', 'Tequila Reposado', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Jalisco, Mexico',
   'Reposado aged 11 months. Long-aged for a reposado, with deep oak character.',
   '["oak","caramel","agave"]'::jsonb, 'pending'),
  ('Espolon Blanco', 'Espolon', 'Spirit', 'Tequila Blanco', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 40, 'Jalisco, Mexico',
   'Mid-tier blanco with bold agave character. Popular cocktail tequila for the price.',
   '["agave","pepper","bold"]'::jsonb, 'pending'),
  ('El Tesoro Platinum', 'El Tesoro', 'Spirit', 'Tequila Blanco', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Jalisco, Mexico',
   'Tahona-made blanco. Cocktail community favorite for traditional production.',
   '["agave","earthy","mineral"]'::jsonb, 'pending'),
  ('Fortaleza Blanco', 'Fortaleza', 'Spirit', 'Tequila Blanco', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Jalisco, Mexico',
   'Tahona-crushed, copper pot still tequila. Bartender darling.',
   '["agave","cooked","earthy"]'::jsonb, 'pending'),
  ('Cazadores Reposado', 'Cazadores', 'Spirit', 'Tequila Reposado', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 40, 'Jalisco, Mexico',
   'Mid-tier reposado. Common well tequila in cocktail-forward bars.',
   '["mellow","oak","agave"]'::jsonb, 'pending'),
  ('Siete Leguas Blanco', 'Siete Leguas', 'Spirit', 'Tequila Blanco', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Jalisco, Mexico',
   'Family-owned distillery using traditional methods. Cult bartender brand.',
   '["agave","cooked","earthy"]'::jsonb, 'pending'),
  ('Del Maguey Vida', 'Del Maguey', 'Spirit', 'Mezcal Joven', '[{"kind":"milliliters","ml":750}]'::jsonb, 42, 'Oaxaca, Mexico',
   'Single-village espadin mezcal. The cocktail mezcal default; affordable enough for mixing.',
   '["smoky","agave","earthy"]'::jsonb, 'pending'),
  ('Ilegal Joven', 'Ilegal', 'Spirit', 'Mezcal Joven', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Oaxaca, Mexico',
   'Smooth, lighter mezcal style. Popular in upscale cocktail programs.',
   '["smoky","tropical","mellow"]'::jsonb, 'pending'),
  ('Montelobos', 'Montelobos', 'Spirit', 'Mezcal Joven', '[{"kind":"milliliters","ml":750}]'::jsonb, 43.2, 'Oaxaca, Mexico',
...
INSERT INTO canonical_products (name, brand, category, subcategory, default_sizes, abv, origin, description, flavor_notes, enrichment_status)
VALUES
  ('Maker''s Mark', 'Maker''s Mark', 'Spirit', 'Bourbon', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 45, 'Loretto, KY, USA',
   'Wheated bourbon, no rye in mash bill. Soft, sweet character with red wax dipped bottle.',
   '["caramel","wheat","soft"]'::jsonb, 'pending'),
  ('Buffalo Trace', 'Buffalo Trace', 'Spirit', 'Bourbon', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 45, 'Frankfort, KY, USA',
  ...
  ('Woodford Reserve', 'Woodford Reserve', 'Spirit', 'Bourbon', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 45.2, 'Versailles, KY, USA',
   'Premium small-batch bourbon. Triple-distilled (unusual for bourbon); fruit-forward.',
   '["caramel","fruit","oak"]'::jsonb, 'pending'),
  ('Bulleit Bourbon', 'Bulleit', 'Spirit', 'Bourbon', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 45, 'Kentucky, USA',
   'High-rye bourbon (~28% rye in mash). Spicier than typical bourbons; cocktail-friendly.',
   '["spicy","oak","caramel"]'::jsonb, 'pending'),
  ('Knob Creek', 'Knob Creek', 'Spirit', 'Bourbon', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 50, 'Clermont, KY, USA',
   'Small-batch 100-proof bourbon. Robust character; from the Jim Beam family.',
   '["caramel","oak","spice"]'::jsonb, 'pending'),
  ('Four Roses Yellow Label', 'Four Roses', 'Spirit', 'Bourbon', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 40, 'Lawrenceburg, KY, USA',
   'Entry Four Roses expression. Floral with light spice.',
   '["floral","light spice","caramel"]'::jsonb, 'pending'),
  ('Wild Turkey 101', 'Wild Turkey', 'Spirit', 'Bourbon', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 50.5, 'Lawrenceburg, KY, USA',
   '101 proof; cocktail bartender favorite for backbone in stirred drinks.',
   '["spicy","caramel","robust"]'::jsonb, 'pending'),
  ('Elijah Craig Small Batch', 'Elijah Craig', 'Spirit', 'Bourbon', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 47, 'Bardstown, KY, USA',
  ...
  ('Eagle Rare', 'Eagle Rare', 'Spirit', 'Bourbon', '[{"kind":"milliliters","ml":750}]'::jsonb, 45, 'Frankfort, KY, USA',
   '10-year-aged single-barrel bourbon from Buffalo Trace. Sipping bourbon.',
   '["oak","caramel","subtle smoke"]'::jsonb, 'pending'),
  ('Old Forester 86 Proof', 'Old Forester', 'Spirit', 'Bourbon', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 43, 'Louisville, KY, USA',
   'Brown-Forman''s flagship bourbon. Reliable and inexpensive for cocktails.',
   '["caramel","oak","mellow"]'::jsonb, 'pending'),
  ('Old Forester 100 Proof', 'Old Forester', 'Spirit', 'Bourbon', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 50, 'Louisville, KY, USA',
   'Higher-proof signature for stirred bourbon drinks; bartender favorite.',
   '["caramel","spice","oak"]'::jsonb, 'pending'),
  ('Larceny', 'Larceny', 'Spirit', 'Bourbon', '[{"kind":"milliliters","ml":750}]'::jsonb, 46, 'Bardstown, KY, USA',
   'Wheated bourbon from Heaven Hill. Sweet and approachable.',
   '["caramel","wheat","sweet"]'::jsonb, 'pending'),
  ('Evan Williams Black Label', 'Evan Williams', 'Spirit', 'Bourbon', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 43, 'Bardstown, KY, USA',
   'Mass-market well bourbon. Common bar pour.',
   '["caramel","oak","mild"]'::jsonb, 'pending'),
  ('Jim Beam White Label', 'Jim Beam', 'Spirit', 'Bourbon', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 40, 'Clermont, KY, USA',
...
INSERT INTO canonical_products (name, brand, category, subcategory, default_sizes, abv, origin, description, flavor_notes, enrichment_status)
VALUES
  ('Bulleit Rye', 'Bulleit', 'Spirit', 'Rye Whiskey', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 45, 'Kentucky, USA',
   'High-rye mash (95% rye, 5% malted barley). Wide bar distribution.',
   '["spicy","peppery","grain"]'::jsonb, 'pending'),
  ('Rittenhouse Rye Bottled in Bond', 'Rittenhouse', 'Spirit', 'Rye Whiskey', '[{"kind":"milliliters","ml":750}]'::jsonb, 50, 'Bardstown, KY, USA',
   '100-proof bonded rye. The cocktail bartender''s default rye for Manhattans and Sazeracs.',
   '["spicy","caramel","robust"]'::jsonb, 'pending'),
  ('Sazerac Rye', 'Sazerac', 'Spirit', 'Rye Whiskey', '[{"kind":"milliliters","ml":750}]'::jsonb, 45, 'Frankfort, KY, USA',
   'Buffalo Trace''s entry rye. The eponymous spirit for the Sazerac cocktail.',
   '["spicy","caramel","mellow"]'::jsonb, 'pending'),
  ('High West Double Rye', 'High West', 'Spirit', 'Rye Whiskey', '[{"kind":"milliliters","ml":750}]'::jsonb, 46, 'Park City, UT, USA',
   'Blend of two rye whiskeys. Modern American craft rye.',
   '["spicy","fruit","grain"]'::jsonb, 'pending'),
  ('Old Overholt', 'Old Overholt', 'Spirit', 'Rye Whiskey', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 40, 'Kentucky, USA',
   'Historic Pennsylvania-style rye, now made in Kentucky. Affordable cocktail rye.',
   '["spicy","mild","grain"]'::jsonb, 'pending'),
  ('WhistlePig 10 Year', 'WhistlePig', 'Spirit', 'Rye Whiskey', '[{"kind":"milliliters","ml":750}]'::jsonb, 50, 'Vermont, USA (Canadian sourced)',
...
INSERT INTO canonical_products (name, brand, category, subcategory, default_sizes, abv, origin, description, flavor_notes, enrichment_status)
VALUES
  ('Johnnie Walker Black Label', 'Johnnie Walker', 'Spirit', 'Scotch', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 40, 'Scotland',
   'Blended Scotch aged at least 12 years. Common premium pour and Penicillin base.',
   '["smoke","malt","fruit"]'::jsonb, 'pending'),
  ('Johnnie Walker Red Label', 'Johnnie Walker', 'Spirit', 'Scotch', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 40, 'Scotland',
   'Entry-level Johnnie Walker blended Scotch. Mass market.',
   '["malt","light smoke","grain"]'::jsonb, 'pending'),
  ('Dewar''s White Label', 'Dewar''s', 'Spirit', 'Scotch', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 40, 'Scotland',
   'Approachable blended Scotch. Common well Scotch.',
   '["mellow","malt","light"]'::jsonb, 'pending'),
  ('Chivas Regal 12', 'Chivas Regal', 'Spirit', 'Scotch', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Scotland',
   '12-year blended Scotch. Historic premium blend.',
   '["honey","oak","fruit"]'::jsonb, 'pending'),
  ('Monkey Shoulder', 'Monkey Shoulder', 'Spirit', 'Scotch', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Speyside, Scotland',
   'Blend of three Speyside single malts. Designed for cocktails.',
   '["honey","vanilla","malt"]'::jsonb, 'pending'),
  ('Glenfiddich 12', 'Glenfiddich', 'Spirit', 'Scotch', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Speyside, Scotland',
   'Best-selling single malt globally. Pear and oak character.',
   '["pear","honey","oak"]'::jsonb, 'pending'),
  ('The Macallan 12 Double Cask', 'Macallan', 'Spirit', 'Scotch', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Speyside, Scotland',
   'Sherry and bourbon cask blend. Premium Speyside single malt.',
   '["sherry","honey","oak"]'::jsonb, 'pending'),
  ('Laphroaig 10', 'Laphroaig', 'Spirit', 'Scotch', '[{"kind":"milliliters","ml":750}]'::jsonb, 43, 'Islay, Scotland',
   'Heavily peated Islay single malt. Iconic for medicinal smoke character.',
   '["peat","smoke","iodine"]'::jsonb, 'pending'),
  ('Lagavulin 16', 'Lagavulin', 'Spirit', 'Scotch', '[{"kind":"milliliters","ml":750}]'::jsonb, 43, 'Islay, Scotland',
   '16-year Islay single malt. Smoke balanced with sherry sweetness.',
   '["peat","smoke","sherry"]'::jsonb, 'pending'),
  ('Highland Park 12', 'Highland Park', 'Spirit', 'Scotch', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Orkney, Scotland',
   'Lightly peated Orkney single malt. Heather honey and gentle smoke.',
   '["heather","honey","light smoke"]'::jsonb, 'pending'),
  ('Talisker 10', 'Talisker', 'Spirit', 'Scotch', '[{"kind":"milliliters","ml":750}]'::jsonb, 45.8, 'Skye, Scotland',
   'Isle of Skye single malt. Maritime peppery smoke.',
   '["peppery","smoke","sea air"]'::jsonb, 'pending'),
  ('The Glenlivet 12', 'The Glenlivet', 'Spirit', 'Scotch', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Speyside, Scotland',
   'Founding Speyside distillery. Light fruit and honey.',
   '["honey","fruit","floral"]'::jsonb, 'pending');


-- ============================================================
-- WHISKEY: IRISH + JAPANESE + TENNESSEE + CANADIAN
-- ============================================================

INSERT INTO canonical_products (name, brand, category, subcategory, default_sizes, abv, origin, description, flavor_notes, enrichment_status)
VALUES
  ('Jameson', 'Jameson', 'Spirit', 'Irish Whiskey', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 40, 'Ireland',
   'Triple-distilled Irish blended whiskey. Best-selling Irish whiskey worldwide.',
   '["smooth","light","grain"]'::jsonb, 'pending'),
  ('Tullamore D.E.W.', 'Tullamore', 'Spirit', 'Irish Whiskey', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 40, 'Ireland',
   'Triple-distilled triple-blend Irish whiskey. Smooth and approachable.',
   '["smooth","grain","mild fruit"]'::jsonb, 'pending'),
  ('Bushmills Original', 'Bushmills', 'Spirit', 'Irish Whiskey', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000}]'::jsonb, 40, 'Northern Ireland',
   'Northern Irish blended whiskey. Lighter and slightly fruitier than Jameson.',
   '["fruit","grain","light malt"]'::jsonb, 'pending'),
  ('Redbreast 12', 'Redbreast', 'Spirit', 'Irish Whiskey', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Ireland',
   'Single pot still Irish whiskey. Premium category benchmark.',
   '["fruit","spice","sherry"]'::jsonb, 'pending'),
  ('Suntory Toki', 'Suntory', 'Spirit', 'Japanese Whisky', '[{"kind":"milliliters","ml":750}]'::jsonb, 43, 'Japan',
   'Japanese blended whisky. Designed for highballs.',
   '["light","fruit","floral"]'::jsonb, 'pending'),
  ('Nikka From the Barrel', 'Nikka', 'Spirit', 'Japanese Whisky', '[{"kind":"milliliters","ml":500}]'::jsonb, 51.4, 'Japan',
   'High-strength Japanese blended whisky. Cult bartender favorite.',
   '["spice","fruit","oak"]'::jsonb, 'pending'),
  ('Hibiki Japanese Harmony', 'Hibiki', 'Spirit', 'Japanese Whisky', '[{"kind":"milliliters","ml":700}]'::jsonb, 43, 'Japan',
   'Premium blended Japanese whisky from Suntory. Elegant and floral.',
   '["floral","honey","fruit"]'::jsonb, 'pending'),
  ('Jack Daniel''s Old No. 7', 'Jack Daniel''s', 'Spirit', 'Tennessee Whiskey', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 40, 'Lynchburg, TN, USA',
  ...
  ('Gentleman Jack', 'Jack Daniel''s', 'Spirit', 'Tennessee Whiskey', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Lynchburg, TN, USA',
   'Double-mellowed Jack Daniel''s. Smoother than Old No. 7.',
   '["smooth","caramel","banana"]'::jsonb, 'pending'),
  ('Crown Royal', 'Crown Royal', 'Spirit', 'Canadian Whisky', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 40, 'Canada',
   'Best-selling Canadian whisky in the US. Soft and approachable.',
   '["smooth","vanilla","light spice"]'::jsonb, 'pending'),
  ('Canadian Club', 'Canadian Club', 'Spirit', 'Canadian Whisky', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 40, 'Canada',
   'Blended Canadian whisky. Classic Old Fashioned alternative.',
   '["mild","grain","slightly sweet"]'::jsonb, 'pending');


-- ============================================================
-- BRANDY + COGNAC + APPLE BRANDY + CALVADOS
-- Locked subs: Cognac / Armagnac / Calvados / Pisco / Brandy (catchall)
-- ============================================================

INSERT INTO canonical_products (name, brand, category, subcategory, default_sizes, abv, origin, description, flavor_notes, enrichment_status)
VALUES
  ('Hennessy VS', 'Hennessy', 'Spirit', 'Cognac', '[{"kind":"milliliters","ml":750},{"kind":"milliliters","ml":1000},{"kind":"milliliters","ml":1750}]'::jsonb, 40, 'Cognac, France',
   'Most-sold Cognac globally. Entry-level VS aged at least 2 years.',
   '["fruit","oak","vanilla"]'::jsonb, 'pending'),
  ('Hennessy VSOP', 'Hennessy', 'Spirit', 'Cognac', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Cognac, France',
   'Mid-tier Cognac aged at least 4 years. Used in Sidecars and stirred Cognac drinks.',
   '["dried fruit","oak","caramel"]'::jsonb, 'pending'),
  ('Remy Martin VSOP', 'Remy Martin', 'Spirit', 'Cognac', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Cognac, France',
   'VSOP from a top Cognac house. Bright fruit and oak.',
   '["fruit","floral","oak"]'::jsonb, 'pending'),
  ('Pierre Ferrand 1840 Original Formula', 'Pierre Ferrand', 'Spirit', 'Cognac', '[{"kind":"milliliters","ml":750}]'::jsonb, 45, 'Cognac, France',
  ...
  ('Calvados', NULL, 'Spirit', 'Calvados', '[{"kind":"milliliters","ml":750}]'::jsonb, 40, 'Normandy, France',
