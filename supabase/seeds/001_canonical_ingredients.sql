...
-- Dairy / Egg / Spice / Herb stay flat (no subcategory).
--
...
-- Locked subs: Citrus / Tropical / Berry / Vegetable / Other
-- ============================================================
...
VALUES
  ...
  ('Apple Juice', NULL, 'Juice', 'Other', '[{"kind":"milliliters","ml":1000}]'::jsonb, 0, NULL,
...
-- Locked subs: Plain / Sweetener / Flavored / Spiced / Nut / Grenadine / Other
-- ============================================================
...
VALUES
  ...
  ('Demerara Syrup', NULL, 'Syrup', 'Plain', '[{"kind":"milliliters","ml":500}]'::jsonb, 0, NULL,
  ...
  ('Honey Syrup', NULL, 'Syrup', 'Sweetener', '[{"kind":"milliliters","ml":500}]'::jsonb, 0, NULL,
  ...
  ('Ginger Syrup', NULL, 'Syrup', 'Spiced', '[{"kind":"milliliters","ml":500}]'::jsonb, 0, NULL,
  ...
  ('Grenadine', NULL, 'Syrup', 'Grenadine', '[{"kind":"milliliters","ml":500}]'::jsonb, 0, NULL,
  ...
  ('Agave Syrup', NULL, 'Syrup', 'Sweetener', '[{"kind":"milliliters","ml":500}]'::jsonb, 0, NULL,
  ...
  ('Maple Syrup', NULL, 'Syrup', 'Sweetener', '[{"kind":"milliliters","ml":500}]'::jsonb, 0, NULL,
   'Boiled maple sap. Adds woodsy sweetness; pairs especially well with whiskey and rye.',
   '["caramel","woodsy","sweet"]'::jsonb, 'pending'),
  ('Cinnamon Syrup', NULL, 'Syrup', 'Spiced', '[{"kind":"milliliters","ml":500}]'::jsonb, 0, NULL,
   'Sugar syrup infused with cinnamon. Tiki and fall cocktail staple.',
   '["warm","spicy","sweet"]'::jsonb, 'pending'),
  ('Vanilla Syrup', NULL, 'Syrup', 'Flavored', '[{"kind":"milliliters","ml":500}]'::jsonb, 0, NULL,
  ...
  ('Raspberry Syrup', NULL, 'Syrup', 'Flavored', '[{"kind":"milliliters","ml":500}]'::jsonb, 0, NULL,
...
-- Locked subs: Soda / Energy / Cocktail Mix / Other
-- ============================================================

INSERT INTO canonical_products (name, brand, category, subcategory, default_sizes, abv, origin, description, flavor_notes, enrichment_status)
VALUES
  ('Club Soda', NULL, 'Mixer', 'Soda', '[{"kind":"milliliters","ml":1000}]'::jsonb, 0, NULL,
   'Carbonated water with added minerals. Used in highballs, spritzes, and to top sours.',
   '["mineral","crisp","clean"]'::jsonb, 'pending'),
  ('Tonic Water', NULL, 'Mixer', 'Soda', '[{"kind":"milliliters","ml":1000}]'::jsonb, 0, NULL,
   'Carbonated water with quinine and sugar. Bitter-sweet; the classic gin partner.',
   '["bitter","floral","sweet"]'::jsonb, 'pending'),
  ('Ginger Beer', NULL, 'Mixer', 'Soda', '[{"kind":"milliliters","ml":355}]'::jsonb, 0, NULL,
  ...
  ('Ginger Ale', NULL, 'Mixer', 'Soda', '[{"kind":"milliliters","ml":355}]'::jsonb, 0, NULL,
   'Sweeter and milder than ginger beer. Used in highballs and as a soft mixer.',
   '["sweet","mild","spicy"]'::jsonb, 'pending'),
  ('Cola', NULL, 'Mixer', 'Soda', '[{"kind":"milliliters","ml":355}]'::jsonb, 0, NULL,
  ...
  ('Lemon-Lime Soda', NULL, 'Mixer', 'Soda', '[{"kind":"milliliters","ml":355}]'::jsonb, 0, NULL,
  ...
  ('Soda Water', NULL, 'Mixer', 'Soda', '[{"kind":"milliliters","ml":1000}]'::jsonb, 0, NULL,
   'Plain carbonated water. Functionally similar to club soda without added minerals.',
   '["neutral","crisp"]'::jsonb, 'pending'),
  ('Champagne (mixer use)', NULL, 'Mixer', 'Other', '[{"kind":"milliliters","ml":750}]'::jsonb, 12, NULL,
...
-- ============================================================
-- DAIRY + EGG (flat — no subcategory per locked taxonomy)
-- ============================================================

INSERT INTO canonical_products (name, brand, category, subcategory, default_sizes, abv, origin, description, flavor_notes, enrichment_status)
VALUES
  ('Heavy Cream', NULL, 'Dairy', NULL, '[{"kind":"milliliters","ml":480}]'::jsonb, 0, NULL,
  ...
  ('Egg White', NULL, 'Egg', NULL, '[{"kind":"namedOunces","name":"One Whole Egg","ounces":1}]'::jsonb, 0, NULL,
   'White portion of a chicken egg. Adds frothy texture to sours; typically 1 egg = ~1 oz white.',
   '["neutral","texture"]'::jsonb, 'pending'),
  ('Whole Egg', NULL, 'Egg', NULL, '[{"kind":"namedOunces","name":"One Whole Egg","ounces":1.7}]'::jsonb, 0, NULL,
   'Whole chicken egg. Used in flips and cream-rich cocktails.',
   '["rich","creamy","neutral"]'::jsonb, 'pending'),
  ('Egg Yolk', NULL, 'Egg', NULL, '[{"kind":"namedOunces","name":"One Whole Egg","ounces":0.7}]'::jsonb, 0, NULL,
...
-- Locked subs: Citrus / Cherry / Olive / Onion / Herb / Rim / Other
-- ============================================================
...
VALUES
  ...
  ('Cocktail Onion', NULL, 'Garnish', 'Onion', '[{"kind":"unitQuantity","unitType":"oneThing","name":"1 onion","quantity":1,"ounces":0}]'::jsonb, 0, NULL,
   'Pickled pearl onion. Distinguishes a Gibson from a Martini.',
   '["briny","sharp"]'::jsonb, 'pending'),
  ('Olive', NULL, 'Garnish', 'Olive', '[{"kind":"unitQuantity","unitType":"oneThing","name":"1 olive","quantity":1,"ounces":0}]'::jsonb, 0, NULL,
...
-- ============================================================
-- SPICE (flat — no subcategory per locked taxonomy)
-- ============================================================

INSERT INTO canonical_products (name, brand, category, subcategory, default_sizes, abv, origin, description, flavor_notes, enrichment_status)
VALUES
  ('Nutmeg (Grated)', NULL, 'Spice', NULL, '[{"kind":"namedOunces","name":"Pinch","ounces":0}]'::jsonb, 0, NULL,
   'Freshly grated nutmeg. Classic top for flips, eggnog, and Painkillers.',
   '["warm","earthy","sweet"]'::jsonb, 'pending'),
  ('Cinnamon Stick', NULL, 'Spice', NULL, '[{"kind":"unitQuantity","unitType":"oneThing","name":"1 stick","quantity":1,"ounces":0}]'::jsonb, 0, NULL,
   'Whole cinnamon. Used as garnish on hot drinks and tiki cocktails.',
   '["warm","sweet","woody"]'::jsonb, 'pending'),
  ('Black Pepper', NULL, 'Spice', NULL, '[{"kind":"namedOunces","name":"Pinch","ounces":0}]'::jsonb, 0, NULL,
   'Freshly ground black pepper. Used on Bloody Mary tops and savory cocktails.',
   '["spicy","earthy"]'::jsonb, 'pending'),
  ('Star Anise', NULL, 'Spice', NULL, '[{"kind":"unitQuantity","unitType":"oneThing","name":"1 pod","quantity":1,"ounces":0}]'::jsonb, 0, NULL,
...
-- Locked subs: Syrup / Infusion / Oleo Saccharum / Shrub / Tincture / Cordial / Other
-- ============================================================

INSERT INTO canonical_products (name, brand, category, subcategory, default_sizes, abv, origin, description, flavor_notes, enrichment_status)
VALUES
  ('Oleo Saccharum', NULL, 'Prepped', 'Oleo Saccharum', '[{"kind":"milliliters","ml":250}]'::jsonb, 0, NULL,
  ...
  ('Shrub (Berry)', NULL, 'Prepped', 'Shrub', '[{"kind":"milliliters","ml":500}]'::jsonb, 0, NULL,
