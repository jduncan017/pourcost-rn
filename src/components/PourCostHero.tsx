        ...
        <View className="px-6 py-5 flex-col gap-3">
          ...
          <View className="flex-row justify-between items-end">
            <View className="flex-row items-baseline gap-1">
              <Text style={{ color: perf.color, fontSize: 32, fontWeight: '700', lineHeight: 36 }}>
                {pourCostPercentage.toFixed(1)}
              </Text>
              <Text style={{ color: perf.color, fontSize: 18, fontWeight: '600' }}>%</Text>
            </View>
          ...
          <View className="relative">
            <View
              ...
              style={{ height: 2, backgroundColor: colors.inputBg }}
            >
              <View
            ...
            <View
              className="absolute"
              style={{ left: `${goalPercent}%`, top: -2, bottom: -2, marginLeft: -1 }}
            >
              <View
                style={{
                  width: 2,
