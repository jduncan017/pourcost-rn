      ...
      <View className="p-4">
        ...
        <View className="card mb-6">
          <View className="items-center mb-4">
            ...
            <Text className="text-xl font-bold text-g4">PourCost</Text>
            <Text className="text-g3">Version 1.0.0</Text>
          </View>
          <Text className="text-g4 text-center leading-relaxed">
        ...
        <View className="card mb-6">
          ...
          <View className="space-y-2">
            <Text className="text-g4">• Calculate cost per pour for any ingredient</Text>
            <Text className="text-g4">• Create and save complex cocktail recipes</Text>
            <Text className="text-g4">• Set profit margins and suggested pricing</Text>
            <Text className="text-g4">• Support for US and Metric measurements</Text>
            <Text className="text-g4">• Multi-currency support</Text>
            <Text className="text-g4">• Cloud sync across devices</Text>
          </View>
        </View>
        ...
        <View className="card mb-6">
          ...
          <View className="space-y-3">
            <View className="bg-n1 p-4 rounded-lg">
              <Text className="font-medium text-g4 mb-1">
        ...
        <Card>
          ...
          <Text className="text-g4 leading-relaxed">
